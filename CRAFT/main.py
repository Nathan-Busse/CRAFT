...
# Textures
arm_texture = load_texture ( 'resources/arm_texture.png' )
sky_texture = load_texture ( 'resources/waters.jpg' )

grass_texture = load_texture ( 'resources/grass.jpeg' )
dirt_texture = load_texture ( 'resources/dirt.jpeg' )
stone_texture = load_texture ( 'resources/stones.jpeg' )
cobblestone_texture = load_texture ( 'resources/brick.jpeg' )
...
# Items
grass_block = load_texture ( 'resources/grass.jpeg' )  # Item not created yet, will be used for inventories
dirt_block = load_texture ( 'resources/dirt.jpeg' )  # Item not created yet, will be used for inventories
stone_block = load_texture ( 'resources/stones.jpeg' )  # Item not created yet, will be used for inventories
cobblestone_block = load_texture (
    'resources/brick.jpeg' )  # Item not created yet, will be used for inventories

iron_boots = load_texture ( 'resources/iron_boots_texture.png' )  # Item not created yet, will be used for inventories
iron_leggings = load_texture (
    'resources/iron_leggings_texture.png' )  # Item not created yet, will be used for inventories
iron_chestplate = load_texture (
    'resources/iron_chestplate_texture.png' )  # Item not created yet, will be used for inventories
...
class Inventory ( Entity ):
    ...
    class Lower_Inventory ( Entity ):
        ...
        def find_free_spot(self):
            for y in range ( 3 ):
                for x in range ( 9 ):
                    grid_positions = [(int ( e.x * self.texture_scale[0] ) , int ( e.y * self.texture_scale[1] )) for e
                                      in
                                      self.children]
...
class Voxel ( Entity ):
    def __init__(self , position=(0 , 0 , 0) , texture=grass_texture):
        ...
        super ().__init__ (
            ...
            origin_y=0.66 ,
            texture=texture ,
            color=color.color ( 0 , 0 , random.uniform ( .8 , .984 ) ) ,  # Each block has a random grayscale shade
            scale=1
        )
...
sky = Sky ()  # Maps the sky to the scene
